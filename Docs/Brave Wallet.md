...
You can see the Wallet implementation progress [here (github.com)](https://github.com/brave/brave-browser/projects/24).

- Brave [Wallet’s source code (github.com)](https://github.com/brave/brave-core/blob/master/LICENSE) is available under an Open Source license, unlike other popular web 3.0 extensions.
